...
% =========================================================================
dias_escolhidos = [2 3 13 30 31]; % dias escolhidos
...
% cria o nome do arquivo que indica quais dias foram extraídos, por exemplo, "matrix_diffTEC_Aug2011_dias_calmos(aqui entram os dias)"
dias_str = sprintf('%d_', dias_escolhidos);
output_name = ['matrix_diffTEC_Aug2011_dias_calmos', dias_str(1:end-1), '.txt'];
