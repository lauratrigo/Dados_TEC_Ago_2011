...
dias_escolhidos = [2 3 13 30 31];  % dias escolhidos com base no índice Kp no site do Kyoto wdc
...
output_file = fullfile(output_folder, 'matrix_diffTEC_Aug2025_dias_calmos.txt');
